...
- [Agents](/docs/concepts/agents) — the full agent contract and `cmd/2` lifecycle
- [Actions](/docs/concepts/actions) — the pure functions that strategies execute
- [Directives](/docs/concepts/directives) — the effect payloads that strategies return
- [Agent runtime](/docs/concepts/agent-runtime) — run strategy-backed agents under OTP supervision
