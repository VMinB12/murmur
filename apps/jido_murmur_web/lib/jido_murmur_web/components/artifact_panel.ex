defmodule JidoMurmurWeb.Components.ArtifactPanel do
  ...
  renderer modules based on artifact name. The generic package does not ship
  domain-specific renderers; consumers provide any specialized artifact
  renderers through the `:renderers` assign and fall back to `Generic` for
  unknown types.
